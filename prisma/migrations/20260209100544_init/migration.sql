...
-- AddForeignKey
ALTER TABLE "TutorCategory" ADD CONSTRAINT "TutorCategory_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Subject"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_tutorCategoryId_fkey" FOREIGN KEY ("tutorCategoryId") REFERENCES "TutorCategory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
